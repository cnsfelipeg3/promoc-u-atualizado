      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <ScrollReveal>
          <div className="glass-card-highlight p-8 sm:p-12 text-center relative overflow-hidden">
            ...
            <h2 className="font-display text-2xl sm:text-3xl font-bold mb-4 relative z-10 text-foreground">
            ...
            <motion.a href="#planos" className="glow-button text-base inline-flex items-center gap-2 relative z-10" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              Ver planos e começar agora<ArrowRight className="w-4 h-4" />
            </motion.a>
          </div>
        </ScrollReveal>
      </div>
