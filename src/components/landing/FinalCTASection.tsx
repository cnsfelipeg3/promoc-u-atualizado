  ...
  return (
    <section className="relative py-32 px-4 overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(to top, hsl(199 95% 8%) 0%, hsl(199 95% 8% / 0.8) 50%, hsl(199 95% 8% / 0.9) 100%)" }} />
      </div>
      <div className="max-w-3xl mx-auto text-center relative z-10">
        <ScrollReveal>
          <h2 className="font-display text-3xl sm:text-5xl font-bold mb-6 text-balance leading-tight text-white">
