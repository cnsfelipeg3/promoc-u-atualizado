...
function buildCreatomatePayload(
  ...
  const elements: Record<string, unknown>[] = [
    ...
    { type: "text", track: 3, text: "PromoCéu ✈️", time: 0, duration: 30, x: "50%", y: "6%", width: "60%", height: "auto", x_alignment: 50, y_alignment: 50, fill_color: "#FFFFFF", font_family: "Montserrat", font_weight: 700, font_size: "5.5 vmin", shadow_color: "rgba(0,0,0,0.7)", shadow_blur: 8, opacity: "90%" },
    ...
    { type: "text", track: 3, text: ov.destino.toUpperCase(), time: 18, duration: 12, x: "50%", y: "70%", width: "90%", height: "auto", x_alignment: 50, y_alignment: 50, fill_color: "#FFFFFF", font_family: "Montserrat", font_weight: 900, font_size: "10 vmin", shadow_color: "rgba(0,0,0,0.8)", shadow_blur: 12 },
    { type: "text", track: 3, text: ov.preco, time: 20, duration: 10, x: "50%", y: "80%", width: "80%", height: "auto", x_alignment: 50, y_alignment: 50, fill_color: "#00FF88", font_family: "Montserrat", font_weight: 900, font_size: "12 vmin", shadow_color: "rgba(0,0,0,0.8)", shadow_blur: 10 },
    { type: "text", track: 3, text: "de " + ov.preco_normal, time: 20, duration: 10, x: "50%", y: "75%", width: "60%", height: "auto", x_alignment: 50, y_alignment: 50, fill_color: "rgba(255,255,255,0.7)", font_family: "Montserrat", font_weight: 400, font_size: "4.5 vmin", text_decoration: "line-through" },
    { type: "text", track: 3, text: ov.cia + " • " + ov.escalas + " • " + ov.tipo, time: 22, duration: 8, x: "50%", y: "88%", width: "85%", height: "auto", x_alignment: 50, y_alignment: 50, fill_color: "#FFFFFF", font_family: "Montserrat", font_weight: 600, font_size: "4 vmin" },
    { type: "text", track: 3, text: "🔥 Link na bio • PromoCéu", time: 25, duration: 5, x: "50%", y: "94%", width: "85%", height: "auto", x_alignment: 50, y_alignment: 50, fill_color: "#FFFFFF", background_color: "rgba(0,0,0,0.6)", background_x_padding: "10%", background_y_padding: "8%", background_border_radius: "20", font_family: "Montserrat", font_weight: 700, font_size: "4.5 vmin" },
  ];
  if (narrationUrl) {
